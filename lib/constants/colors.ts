...
export const TEAM_SLUG_TO_COLOR: Record<string, string> = {
  ...
  'NS': TEAM_COLORS['Nongshim RedForce'],
  'GM8': TEAM_COLORS['Gentle Mates'],
  'FUR': TEAM_COLORS['Furia'],
  'BBL': TEAM_COLORS['BBL Esports'],
  'AG': TEAM_COLORS['All Gamers'],
  'TLN': TEAM_COLORS['Talon Esports'],
  ...
  'BLD': TEAM_COLORS['BLEED'],
  'C9': TEAM_COLORS['Cloud9'],
  'EG': TEAM_COLORS['Evil Geniuses'],
  'KOI': TEAM_COLORS['KOI'],
  'KC': TEAM_COLORS['Karmine Corp'],
  'LEV': TEAM_COLORS['Leviatan'],
  'LOUD': TEAM_COLORS['LOUD'],
  'TS': TEAM_COLORS['Team Secret'],
  'GE': TEAM_COLORS['Global Esports'],
